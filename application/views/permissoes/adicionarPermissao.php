                ...
                <div class="widget-content">
                    ...
                    <div class="accordion" id="collapse-group">
                        ...
                        <div class="accordion-group widget-box">
                            <div class="accordion-heading">
                                <div class="widget-title">
                                    <a data-parent="#collapse-group" href="#collapseGThree33339" data-toggle="collapse">
                                        <span class="icon"><i class="fas fa-key"></i></span>
                                        <h5>Carros</h5>
                                    </a>
                                </div>
                            </div>
                            <div class="collapse accordion-body" id="collapseGThree33339">
                                <div class="widget-content">
                                    <table class="table table-bordered">
                                        <tbody>
                                            <tr>
                                                <td>
                                                    <label>
                                                        <input name="vCarro" class="marcar" type="checkbox" checked="checked" value="1" />
                                                        <span class="lbl"> Visualizar Carro</span>
                                                    </label>
                                                </td>
                                                <td>
                                                    <label>
                                                        <input name="aCarro" class="marcar" type="checkbox" value="1" />
                                                        <span class="lbl"> Adicionar Carro</span>
                                                    </label>
                                                </td>
                                                <td>
                                                    <label>
                                                        <input name="eCarro" class="marcar" type="checkbox" value="1" />
                                                        <span class="lbl"> Editar Carro</span>
                                                    </label>
                                                </td>
                                                <td>
                                                    <label>
                                                        <input name="dCarro" class="marcar" type="checkbox" value="1" />
