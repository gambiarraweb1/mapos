                            ...
                            <table class="table table-bordered">
                                <tbody>
                                    ...
                                    <tr>
                                        <td>
                                            <label>
                                                <input <?php if (isset($permissoes['vCarro'])) {
                                                            if ($permissoes['vCarro'] == '1') {
                                                                echo 'checked';
                                                            }
                                                        } ?> name="vCarro" class="marcar" type="checkbox" value="1" />
                                                <span class="lbl"> Visualizar Carro</span>
                                            </label>
                                        </td>
                                        <td>
                                            <label>
                                                <input <?php if (isset($permissoes['aCarro'])) {
                                                            if ($permissoes['aCarro'] == '1') {
                                                                echo 'checked';
                                                            }
                                                        } ?> name="aCarro" class="marcar" type="checkbox" value="1" />
                                                <span class="lbl"> Adicionar Carro</span>
                                            </label>
                                        </td>
                                        <td>
                                            <label>
                                                <input <?php if (isset($permissoes['eCarro'])) {
                                                            if ($permissoes['eCarro'] == '1') {
                                                                echo 'checked';
                                                            }
                                                        } ?> name="eCarro" class="marcar" type="checkbox" value="1" />
                                                <span class="lbl"> Editar Carro</span>
                                            </label>
                                        </td>
                                        <td>
                                            <label>
                                                <input <?php if (isset($permissoes['dCarro'])) {
                                                            if ($permissoes['dCarro'] == '1') {
                                                                echo 'checked';
                                                            }
                                                        } ?> name="dCarro" class="marcar" type="checkbox" value="1" />
                                                <span class="lbl"> Excluir Carro</span>
                                            </label>
                                        </td>
                                    </tr>
                                    <tr>
